...
export async function GET(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'games GET', 'Internal server error', 500);
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'games POST', 'Internal server error', 500);
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'games DELETE', 'Internal server error', 500);
  }
}