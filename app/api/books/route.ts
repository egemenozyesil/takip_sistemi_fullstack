...
export async function GET(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'books GET', 'Internal server error', 500);
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'books POST', 'Internal server error', 500);
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return handleApiError(error, 'books DELETE', 'Internal server error', 500);
  }
}
